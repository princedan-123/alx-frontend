...
* change directory to the cloned repository and create a new directory at the root of the repo. The new directory should be called 0x00-html_advanced.
On linxux terminal.
``` cd alx-frontend ; mkdir 0x00-html_advanced. ```
